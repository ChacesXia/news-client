...
<!--                       <img src="../../assets/img/qrcode.jpg" height="100%" width="100%" class="img_full"> -->
              ...
              <div class="url" style="margin-left:0.4rem;height:3.8rem;margin-bottom: 0.4rem;">
              <a href="https://github.com/ChacesXia" target="_blank" style="height:3.8rem">https://github.com/ChacesXia</a></div>
          </div>
      </div>
    </v-content>
  </div>
...
export default {
  ready () {
    var a = decodeURIComponent(this.$route.params.u)
    console.log(a)
