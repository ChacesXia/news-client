      ...
      <li style="height: 3rem;">
        <div class="item-content" style="min-height: 3rem;">
          ...
          <div class="item-inner" style="min-height: 3rem;">
            ...
            <div class="item-subtitle">个人头像</div>
          </div>
        </div>
      </li>
      <li>
        <div class="item-content">
            <div class="item-inner">
                ...
                <div class="item-input">
                    <input id="nickname" type="text" name="nickname" placeholder="用户昵称" value="Chaces">
                </div>
            </div>
        </div>
      </li>
      ...
      <li>
        <div class="item-content">
            <div class="item-inner">
                ...
                <div class="item-input">
                    <input id="name" type="text" name="name" placeholder="请输入真实姓名" value="夏晨">
                </div>
            </div>
        </div>
      </li>
      <li>
        <div class="item-content">
            <div class="item-inner">
                ...
                <div class="item-input">
                    <input id="name" type="text" name="name" placeholder="请输入微信号" value="wp1217113694">
                </div>
            </div>
        </div>
      </li>
      ...
      <li>
          <div class="item-content">
              <div class="item-inner">
                  ...
                  <div class="item-input">
                      <input id="age" type="number" name="age" placeholder="年龄" value=21>
                  </div>
              </div>
          </div>
      </li>
      ...
      <li>
        <div class="item-content">
            <div class="item-inner">
                ...
                <div class="item-input">
                    <input id="phone" type="text"  name="phone" placeholder="手机号" value="18153221917">
                </div>
            </div>
        </div>
      </li>
      <li>
          <div class="item-content">
              <div class="item-inner">
                  ...
                  <div class="item-input">
                      <input id="occupation" type="text" name="occupation" placeholder="职业" value="学生">
                  </div>
              </div>
          </div>
      </li>
      <li>
          <div class="item-content">
              <div class="item-inner">
                  ...
                  <div class="item-input">
                      <textarea id="address" name="address" placeholder="在此填写详细地址"></textarea>
                  </div>
              </div>
          </div>
      </li>
